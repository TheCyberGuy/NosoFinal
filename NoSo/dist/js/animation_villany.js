...
const ulLI = document.querySelectorAll(".navlink");

ulLI.forEach((item) => {
  item.addEventListener("click", () => {
    document.querySelector(".navbar-toggler").classList.add("collapsed");
    document.querySelector("#navbarNav").classList.add("collapsing");
    document.querySelector("#navbarNav").classList.add("collapsed");
    document.querySelector("#navbarNav").classList.remove("collapsing");
